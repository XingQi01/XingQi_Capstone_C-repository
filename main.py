...
st.subheader("You can use this query below to find available HDB resale flats in Singapore, by querying the location and price range. The table output will show you information related to the HDB resale flats based on your query.")
